...
isotope_summary_df$Model_timestep <- isotope_summary_df$Time+15 #13.42 years is "detection period" (lim yhat -> 0) calculated based on binomial linear regression
